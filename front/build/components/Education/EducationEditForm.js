...
function EducationEditForm({ currentEducation, setEducations, setIsEditing }) {
    ...
    const [school, setSchool] = (0, react_1.useState)(currentEducation.school);
    const [major, setMajor] = (0, react_1.useState)(currentEducation.major);
    const [position, setPosition] = (0, react_1.useState)(currentEducation.position);
    const [fromDate, setFromDate] = (0, react_1.useState)(new Date(currentEducation.fromDate));
    const [toDate, setToDate] = (0, react_1.useState)(new Date(currentEducation.toDate));
    const handleSubmit = (e) => __awaiter(this, void 0, void 0, function* () {
        ...
        yield Api.put(`educations/${currentEducation.id}`, {
            userId,
            school,
            major,
            position,
    ...
    return (<react_bootstrap_1.Form onSubmit={handleSubmit}>
      <react_bootstrap_1.Form.Group controlId="formBasicTitle">
        <react_bootstrap_1.Form.Control type="text" placeholder="School" value={school} onChange={(e) => setSchool(e.target.value)}/>
...
exports.default = EducationEditForm;
