...
function EducationCard({ education, isEditable, setIsEditing, setEducations }) {
    const handleDelete = (e) => __awaiter(this, void 0, void 0, function* () {
        ...
        yield Api.delete(`educations/${education.id}`);
    ...
    return (<react_bootstrap_1.Card.Body>
      <react_bootstrap_1.Row className="align-items-center portfolio-card">
        ...
        <div className="portfolio-card-text">
          ...
          <span className="text-muted">
            {`${(0, moment_1.default)(education.fromDate).format("YYYY-MM-DD")} ~ ${(0, moment_1.default)(education.toDate).format("YYYY-MM-DD")}`}
          </span>
        </div>
        </react_bootstrap_1.Col>
        {isEditable && (<react_bootstrap_1.Col>
          <div style={{ margin: "10px 0 0 200px" }}>
            ...
            <react_bootstrap_1.Button variant="outline-danger" style={{ width: "60px", height: "25px", fontSize: "10px", margin: "0 auto" }} onClick={handleDelete} className="mr-1">
              Delete
            </react_bootstrap_1.Button>
          </div>
          </react_bootstrap_1.Col>)}
