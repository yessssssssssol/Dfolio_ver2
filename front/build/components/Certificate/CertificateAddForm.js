...
function CertificateAddForm({ portfolioOwnerId, setCertificates, setIsAdding, }) {
    ...
    const [whenDate, setWhenDate] = (0, react_1.useState)(new Date());
    const handleSubmit = (e) => __awaiter(this, void 0, void 0, function* () {
        ...
        yield Api.post("certificate/create", {
    ...
    return (<react_bootstrap_1.Form onSubmit={handleSubmit}>
      <react_bootstrap_1.Form.Group controlId="formBasicTitle">
        <react_bootstrap_1.Form.Control type="text" placeholder="Certificate Name" value={title} onChange={(e) => setTitle(e.target.value)}/>
      ...
      <react_bootstrap_1.Form.Group as={react_bootstrap_1.Row} style={{ padding: "0 5px !important" }}>
        <react_bootstrap_1.Col style={{ fontSize: "13px", color: "#777777" }}>Date of Certification</react_bootstrap_1.Col>
...
exports.default = CertificateAddForm;
