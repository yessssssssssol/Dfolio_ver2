...
function AwardCard({ award, isEditable, setIsEditing, setAwards }) {
    const handleDelete = (e) => __awaiter(this, void 0, void 0, function* () {
        ...
        yield Api.delete(`awards/${award.id}`);
      ...
      <react_bootstrap_1.Row className="align-items-center">
        ...
        {isEditable && (<react_bootstrap_1.Col>
            <div style={{ margin: "10px 0 0 200px" }}>
              <react_bootstrap_1.Button variant="outline-info" style={{
                width: "60px",
                height: "25px",
                fontSize: "10px",
                margin: "0 auto",
            }} onClick={() => setIsEditing((prev) => !prev)} className="mr-3">
                Edit
              </react_bootstrap_1.Button>
              <react_bootstrap_1.Button variant="outline-danger" style={{
                width: "60px",
                height: "25px",
                fontSize: "10px",
                margin: "0 auto",
            }} onClick={handleDelete} className="mr-3">
                Delete
              </react_bootstrap_1.Button>
            </div>
          </react_bootstrap_1.Col>)}
